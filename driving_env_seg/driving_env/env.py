...
class ENV(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        self.screen.fill((255,255,255), (400,20,500,30))
        text = self.font.render("REWARD "+str(self._get_reward()), True, (0,0,0))   # 描画する文字列の設定
        self.screen.blit(text, [400, 20])# 文字列の表示位置
